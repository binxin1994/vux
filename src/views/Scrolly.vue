...
export default {
  ...
  methods: {
    getList () {
      ...
      // ajax 请求
      this.isnum++
      if (this.isnum == this.iPageSize) {
        this.$refs.myScroll.setState(3)
        return
      }
      axios.get('https://easy-mock.com/mock/5b90f971ce624c454133ee2d/scoll/datalist?id=' + this.isnum).then(function (response) {
